...
high-variance transition region in between. The value of this work is a careful,
seed-averaged, reported reproduction and the code to run it.
...
The point is to answer both rigorously and
...
- **This is a reproduction plus a small empirical characterization on a toy problem.
...
and report limitations without inflating the result. The most useful
thing it taught me is : you cannot tell whether a question
